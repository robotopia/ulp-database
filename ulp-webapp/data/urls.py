...
urlpatterns = [
    ...
    re_path(r'^timing/observations/(?P<pk>[0-9]+)$', views.observations_view, name="observations_view"),
    re_path(r'^timing/add_toa/(?P<pk>[0-9]+)$', views.add_toa, name="add_toa"),
    re_path(r'^timing/add_observation/(?P<pk>[0-9]+)$', views.add_observation, name="add_observation"),
    re_path(r'^timing/act_on_toas/(?P<pk>[0-9]+)$', views.act_on_toas, name="act_on_toas"),
    re_path(r'^timing/act_on_observations/(?P<pk>[0-9]+)$', views.act_on_observations, name="act_on_observations"),
    ...
    re_path(r'^timing/download_times_of_arrival/(?P<pk>[0-9]+)$', views.download_times_of_arrival, name="download_times_of_arrival"),
